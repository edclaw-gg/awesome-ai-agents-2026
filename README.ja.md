...
> 2. 🗺️ **シナリオを探す** → [シナリオガイド](#-シナリオガイド--何に何を使うべきか)
> 3. 🧩 **実証済みの構成をコピー** → [スタックレシピ](#-stack-recipes--curated-tool-combinations)
> 4. 🔍 **最適なツールを選ぶ** → [比較表](#-比較--サイドバイサイド表)
> 5. ⚠️ **アンチパターンを避ける** → [非推奨リスト](#-anti-picks--what-not-to-use-for)
>
> **已に開発中の方へ：** こちらへジャンプ：
> - 🆕 [最新追加（2026年5月）](#may-2026) • 🛡️ [セキュリティ](#️-エージェントセキュリティ) • 💰 [コスト比較](#-foundation-models--cost--context-comparison)
